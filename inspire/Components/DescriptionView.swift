...
struct DescriptionView: View {
    ...
    init(label: String,_ text: String, lineLimit: Int, font: UIFont = UIFont.preferredFont(forTextStyle: UIFont.TextStyle.body)) {
        self.text = text
        self.label = label
...
struct DescriptionView_Previews: PreviewProvider {
    static var previews: some View {
        DescriptionView(label: "", "test", lineLimit: 2)
    }
}
