...
var MOCK_AUTHORS = [
    ...
    User(firstname: "Néhémie", lastname: "Polleye", email: "bpolleye1@addtoany.com", password: "Wuw3KzwWr", biography: "Synergistic tertiary focus group", spokenLanguages: "francais", avatar: "https://i.pravatar.cc/100?img=49", location: CLLocationCoordinate2D(latitude: 41.0377245, longitude: 21.3300873), notificationsAccepted: true, role: .author, isLogged: false),
    ...
    User(firstname: "Lóng", lastname: "Ventum", email: "aventum3@twitpic.com", password: "DtXI6pUDh7yl", biography: "Programmable composite policy", spokenLanguages: "francais", avatar: "https://i.pravatar.cc/100?img=52",location: CLLocationCoordinate2D(latitude: -23.216667, longitude: 46.6666669), notificationsAccepted: true, role: .author, isLogged: false),
